...
func TestCreateOrApplyServices(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantErr: `failed to create external-secrets/bitwarden-sdk-server: test client error`,
		},
		...
		},
		{
			...
			wantErr: `failed to create external-secrets/external-secrets-webhook: test client error`,
		},
		{
